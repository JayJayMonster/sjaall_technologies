import { version, unref, inject, hasInjectionContext, getCurrentInstance, createApp, effectScope, reactive, useSSRContext, defineAsyncComponent, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, h, isReadonly, isRef, isShallow, isReactive, toRaw, ref, watchEffect, computed, mergeProps } from 'vue';
import { u as useRuntimeConfig$1, $ as $fetch, c as withQuery, h as hasProtocol, p as parseURL, i as isScriptProtocol, j as joinURL, d as createError$1, s as sanitizeStatusCode, e as createHooks, f as isEqual, g as stringifyParsedURL, k as stringifyQuery, a as parseQuery } from '../nitro/node-server.mjs';
...
const useBluetooth = () => {
  ...
  const handleCharacteristicValueChanged = (event) => {
    ...
    const { validRed, validGreen, validBlue } = parseRGBValues(localDecodedData);
...
const _imports_0 = "" + __buildAssetsURL("notext.47aea3f3.png");
const _sfc_main$2 = {
  __name: "app",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col justify-center items-center h-screen m-2" }, _attrs))}><img${ssrRenderAttr("src", _imports_0)} alt="logo" class="h-32 mb-8"><div class="font-bold text-4xl mb-4"><div><h1 class="text-center">SJAALL TECHNOLOGIES</h1><hr class="bg-purple-600 h-0.5 mx-auto sm:mx-8"></div></div><div> Dit is jouw kleur: </div><div class="m-2"><p class="font-bold text-center">${ssrInterpolate(unref(decodedData))}</p></div><div class="flex items-stretch flex-col"><button class="bg-purple-600 hover:bg-purple-600 text-white font-bold py-2 px-4 rounded mb-4">Connect to Bluetooth device</button><button class="bg-purple-600 hover:bg-purple-800 text-white font-bold py-2 px-4 mb-4 rounded">Get Data</button><button class="bg-purple-600 hover:bg-purple-900 text-white font-bold py-2 px-4 rounded">Disconnect</button></div></div>`);
    };
  }
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-8b38e794.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-d0e2c224.mjs').then((r) => r.default || r));
